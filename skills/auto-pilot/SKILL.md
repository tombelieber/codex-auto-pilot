...
6. Do not automatically delete the local worktree or branch after merge or release. Retain it by default and report it; remove it only when cleanup is explicitly requested and fresh Git checks prove it clean, merged, unlocked, and fully reachable from the remote base.
...
Create a temporary v6 completion receipt and validate it:
