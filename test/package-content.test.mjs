...
const intended = [
  ...
  'templates/agents/auto-pilot-fixer.toml', 'templates/agents/auto-pilot-goal-reviewer.toml', 'templates/agents/auto-pilot-implementer.toml', 'templates/agents/auto-pilot-release-reviewer.toml',
].sort()

test('npm pack contains exactly the intended 16 public files', () => {
